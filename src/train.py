...
def run_training(fold, params, save_model):
    ...
    train_loader = /
    load_data_cnn(DATA_PATH, sb_n, train_trial_list, params['batch_size'])
    valid_loader = /
    load_data_cnn(DATA_PATH, sb_n, valid_trial_list, params['batch_size'])
...
def objective(trial, params):
    ...
    params['batch_size'] = /
    trial.suggest_int("batch_size", 128, 256, step=128)
    if params['edl']:
        params['evi_fun'] = /
